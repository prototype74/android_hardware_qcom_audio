...
enum {
    ...
    SND_DEVICE_OUT_VOLTE_HANDSET,
    SND_DEVICE_OUT_VOLTE_SPEAKER,
    SND_DEVICE_OUT_VOLTE_HEADPHONES,
    SND_DEVICE_OUT_VOICE_CP2_HANDSET,
    SND_DEVICE_OUT_VOICE_CP2_SPEAKER,
    SND_DEVICE_OUT_VOICE_CP2_HEADPHONES,
    SND_DEVICE_OUT_VOICE_HANDSET_EXTRA_VOL,
    SND_DEVICE_OUT_VOICE_SPEAKER_EXTRA_VOL,
    SND_DEVICE_OUT_VOLTE_HANDSET_EXTRA_VOL,
    SND_DEVICE_OUT_VOLTE_SPEAKER_EXTRA_VOL,
    SND_DEVICE_OUT_VOICE_CP2_HANDSET_EXTRA_VOL,
    SND_DEVICE_OUT_VOICE_CP2_SPEAKER_EXTRA_VOL,
...
#ifdef SEC_AUDIO_ENABLED
    SND_DEVICE_IN_VOLTE_MAIN_MIC,
    SND_DEVICE_IN_VOLTE_HEADSET_MIC,
    SND_DEVICE_IN_VOICE_CP2_MAIN_MIC,
    SND_DEVICE_IN_VOICE_CP2_HEADSET_MIC,
